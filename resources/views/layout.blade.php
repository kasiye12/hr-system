...
<body>
    ...
    <div class="shell">
        <nav class="sidebar">
            ...
            <a href="{{ route('documents.index') }}" @if(request()->routeIs('documents.*')) class="active" @endif>Documents</a>
            <a href="{{ route('leaves.index') }}" @if(request()->routeIs('leaves.*')) class="active" @endif>📋 Leave Management</a>
